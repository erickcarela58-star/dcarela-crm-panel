const CACHE='dcarela-saleads-20260824-v8';
const ASSETS=['./','./index.html','./styles.css?v=20260824v8','./saleads-core.js?v=20260824v8','./app.js?v=20260824v8','./manifest.webmanifest'];
