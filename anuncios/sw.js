const CACHE='dcarela-saleads-20260824-v6';
const ASSETS=['./','./index.html','./styles.css?v=20260824v6','./saleads-core.js?v=20260824v6','./app.js?v=20260824v6','./manifest.webmanifest'];
